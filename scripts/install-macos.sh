...
export LATEX_TYPORA_SCRIPT_USAGE_PATH="./scripts/install-macos.sh"
export LATEX_TYPORA_INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/main/scripts/install-macos.sh"
